...
class MiniDroneBtAdapter extends EventEmitter {
    ...
    constructor(options) {
        ...
        // note: this is edited for web bluetooth api
        this.noble = require('noble');
        //this.noble = require('noble/with-bindings')(require('../../noble/lib/webbluetooth/bindings.js'));
    ...
    validatePeripheral(peripheral) {
        ...
        } else if (peripheral.advertisement) {
